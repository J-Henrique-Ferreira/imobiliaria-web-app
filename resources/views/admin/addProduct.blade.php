<x-layouts.admin containerTitle="Adicionar imóvel">
    <form class="d-flex flex-column flex-md-row gap-4">
        ...
        <div class="w-100 d-md-flex flex-column gap-3">
            ...
            <div style="margin-top: 22px;">
                ...
                <div class="d-flex flex-column gap-3 overflow-y-scroll  navbar-nav-scroll" style="max-height: 400px;" id="preview_images"></div>
            </div>

            <div class="col-12 text-end mt-4">
                <button type="submit" class="col-5 btn btn-primary">Salvar</button>
            </div>
        </div>
    </form>
</x-layouts.admin>
