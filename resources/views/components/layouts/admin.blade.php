        ...
        <div class="w-100 min-vh-100">
            <div class="d-flex justify-content-between px-3 py-3 fs-3 mb-3">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas"
                    ...
                    <img class="navbar-toggler-icon object-fit-contain   my-auto" style="width: 30px;"
                        src="https://www.contentformula.com/wp-content/uploads/2016/06/hamburger-menu.png"
                        alt="">
                </button>
            </div>
